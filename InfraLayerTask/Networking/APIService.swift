...
class APIService: ArticlesService {
    ...
    func fetchArticles(completion: @escaping (Result<ArticleResponse, Error>) -> Void ) {
        let URLString = "https://newsapi.org/v2/everything?q=tesla&from=2023-02-02&sortBy=publishedAt&apiKey=51b329140d344a59bdcebb0978bfb77b".addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed)!
